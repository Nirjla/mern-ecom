      ...
      return (<>
            ...
            >
                  <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                        <NavLink to='/'>
                              <h1 className="text-3xl text-white">Mern-Admin</h1>
                        </NavLink>
                        <button
                              ref={trigger}
                        ...
                        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
                              ...
                              <div>
                                    ...
                                    <ul className="mb-6 flex flex-col gap-1.5">
                                          {/* <!-- Menu Item Dashboard --> */}
                                          <li>
                                                <SidebarLink to={'dashboard'} icon={<RxDashboard className="text-[20px]"/>} name="dashboard" className={`text-white ${pathname.includes('dashboard') &&
                                                      'bg-graydark dark:bg-meta-4'}`} />
                                          </li>
                                          <li>   <SidebarLinkGroup
                                                activeCondition={pathname === '/products' || pathname.includes('products')}
                                          >
                                                {(handleClick, open) => {
                                                      return (
                                                            <React.Fragment>
                                                                  <SidebarLink to='#' name="Products" className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4  ${(pathname === '/products' || pathname.includes('/products')) &&
                                                                        'bg-graydark dark:bg-meta-4'
                                                                        }`}
                                                                        onClick={(e) => {
                                                                              e.preventDefault();
                                                                        ...
                                                                        dropdownIcon={<RiArrowDropDownLine className={`text-[32px] absolute right-4 top-1/2 -translate-y-1/2 fill-current  ${open && 'rotate-180'}`} />}
                                                                  />
                                                                  ...
                                                                  >
                                                                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                                                              <li>
                                                                                    <SidebarLink name="All products" to={"all-products"} className={'group relative flex items-center gap-2.5 rounded-md px-4 py-0 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white'} />
